...
public class PopupData {
	...
	public static void main(String[] args) throws InterruptedException, IOException, EncryptedDocumentException, InvalidFormatException {
		...
		System.setProperty("webdriver.chrome.driver", "D:\\Santhose Worspace\\chromedriver.exe");
...
//		wb.findElement(By.xpath(".//*[@id='dnn_ctr588_IMRIndex_GV_Search']/tbody/tr[1]/td/table/tbody/tr/td[3]/a")).click();
		...
		{*/
		WebElement elm=wb.findElement(By.id("doct_info_wrapper"));
	            		...
	            		a[i]=alllinks.get(i).getText(); 
	            		 ...
	            		 if(a[i].startsWith("V"))
	                     {
	            			 ...
	            			 for(String ChildWindow : wb.getWindowHandles()){
	     			 		...
	     			 		//#doctorBiodata > tbody > tr:nth-child(1) > td:nth-child(2)
	     			 		//#doctorBiodata > tbody > tr:nth-child(3) > td:nth-child(2)
	     			 		//#doctorBiodata > tbody > tr:nth-child(2) > td:nth-child(2)
	     			 		//#doctorBiodata > tbody > tr:nth-child(4) > td:nth-child(2)
	     			 		//*[@id="doctorBiodata"]/tbody/tr[3]/td[2]
	     			 		//Thread.sleep(3000);
	                         WebElement elm1=wb.findElement(By.cssSelector("#doctorBiodata > tbody > tr:nth-child(1) > td:nth-child(2)"));
	                         WebElement elm2=wb.findElement(By.cssSelector("#doctorBiodata > tbody > tr:nth-child(3) > td:nth-child(2)"));
	                         WebElement elm3=wb.findElement(By.cssSelector("#doctorBiodata > tbody > tr:nth-child(2) > td:nth-child(2)"));
	                         WebElement elm4=wb.findElement(By.cssSelector("#doctorBiodata > tbody > tr:nth-child(8) > td:nth-child(2)"));
	                         WebElement elm5=wb.findElement(By.cssSelector("#doctorBiodata > tbody > tr:nth-child(5) > td:nth-child(4)"));
	                         WebElement elm6=wb.findElement(By.cssSelector("#doctorBiodata > tbody > tr:nth-child(4) > td:nth-child(2)"));
	                         WebElement elm7=wb.findElement(By.cssSelector("#doctorBiodata > tbody > tr:nth-child(6) > td:nth-child(2)"));
	                         WebElement elm8=wb.findElement(By.cssSelector("#doctorBiodata > tbody > tr:nth-child(6) > td:nth-child(4)"));
	                         WebElement elm9=wb.findElement(By.cssSelector("#doctorBiodata > tbody > tr:nth-child(7) > td:nth-child(2)"));
		    			 		System.out.println(elm1.getText()+" "+elm2.getText()+" "+elm3.getText()+" "+elm4.getText()+" "+elm5.getText()+" "+elm6.getText()+" "+elm7.getText()+" "+elm8.getText()+" "+elm9.getText());
		    			 		 ...
		    			 		 try {
		    			 			   ...
		    			 			   //File src=new File("D:\\Santhose\\selenium1.xls");
                                      ...
                                      FileOutputStream fout=new FileOutputStream(new File("D:\\Santhose\\selenium1.xls"));
		    			 		...
		    			 		wb.close();
		    			 		 //Thread.sleep(3000);
		    			 		 //wb.findElement(By.cssSelector("#doctorModal > div.modal-dialog.modal-lg > div > div > div.modal-footer > button")).click();;
